...
import static tn.seif.stedeex.Utils.PreferencesUtility.ADRESSE_USER;
import static tn.seif.stedeex.Utils.PreferencesUtility.EMAIL_USER;
import static tn.seif.stedeex.Utils.PreferencesUtility.FISCALE_USER;
import static tn.seif.stedeex.Utils.PreferencesUtility.FRAIS_USER;
import static tn.seif.stedeex.Utils.PreferencesUtility.ID_USER;
import static tn.seif.stedeex.Utils.PreferencesUtility.LOGGED_IN_PREF;
import static tn.seif.stedeex.Utils.PreferencesUtility.NOM_USER;
import static tn.seif.stedeex.Utils.PreferencesUtility.PRENOM_USER;
import static tn.seif.stedeex.Utils.PreferencesUtility.ROLES_USER;
import static tn.seif.stedeex.Utils.PreferencesUtility.TEL_USER;
import static tn.seif.stedeex.Utils.PreferencesUtility.USERNAME_USER;
...
public class SaveSharedPreference {
    ...
    public static void setUserCredentials(Context context,String id, String nom,String tel,String roles,String prenom,String adresse,String email,String frais,String username,String fiscale) {
        SharedPreferences.Editor editor = getPreferences(context).edit();
        ...
        editor.putString(FISCALE_USER, fiscale);
        editor.apply();
    }
